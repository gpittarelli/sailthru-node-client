(function() {
  ...
  SailthruClient = (function() {
    ...
    SailthruClient.prototype.getIncludes = function(callback) {
      return this.apiGet('include', {}, callback);
    };

    SailthruClient.prototype.getInclude = function(incName, callback) {
      return this.apiGet('include', {include: incName}, callback);
    };
